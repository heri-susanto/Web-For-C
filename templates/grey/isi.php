    ...
    ?>
              ...
              <?php
                ...
                $queryterbaru = "SELECT * FROM halamanstatis
                                WHERE id_halaman=1";
                $hasilterbaru = mysqli_query($konek, $queryterbaru);
				$r = mysqli_fetch_array($hasilterbaru);
	   ...
	   <?php							
        ...
        // Apabila ada gambar dalam agenda, tampilkan.   
         ...
         ?>
			...
			<div class="main-head">
									<a href="semua-berita.html" class="right">semua post</a>
									<div class="main-title">
										<h1>Blog Post</h1>
                ...
                $hasilterbaru = mysqli_query($konek, $queryterbaru);
                  ...
                  <div class=\"date\">
									...
									<div class=\"text\">
										...
										<p>$isi</p>
										<p><a href=\"berita-$t[id_berita]/$t[judul_seo].html\" ><i>Selengkapnya</i></a></p>
									</div>
                </div>";
                } 
              ?>
              ...
              while($m=mysqli_fetch_array($hasilberita)){
                  ...
                  <div class=\"date\">
									...
									<div class=\"text\">
										...
										<p>$isi</p>
										<p><a href=\"$d[alamat_website]/berita-$m[id_berita]/$m[judul_seo].html\"><i>Selengkapnya</i></a></p>
									</div>
                </div>";          
              }
	        ...
	        $tgl = explode(' ', $tanggal); // pisahkan penanggalan -> $tgl[0] = tanggal, $tgl[1] = bulan, $tgl[2] = tahun 
                  ...
                  <div class=\"date\">
									...
									<div class=\"text\">
										...
										<p>$isi</p>
										<p><a href=\"$d[alamat_website]/berita-$t[id_berita]/$t[judul_seo].html\"><i>Selengkapnya</i></a></p>
									</div>
                </div>";          
        }                                                          
      }
